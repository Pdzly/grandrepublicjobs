...
TEAM_KC_HP_SGT = DarkRP.createJob("Heavy Platoon | SGT", {
    ...
    model = {"models/aussiwozzi/phase1clones/keeli/officer.mdl"},
    description = [[]],
    weapons = {"sw_datapad", "weapon_rpw_binoculars", "rw_sw_nade_thermal", "rw_sw_dc15le", "rw_sw_z6", "rw_sw_dc15s", "rw_sw_dc17", "rw_sw_pinglauncher", "weapon_shield_activator", "rw_sw_dual_dc17",},
...
TEAM_KC_HP_LT = DarkRP.createJob("Heavy Platoon | LT", {
    ...
    model = {"models/aussiwozzi/phase1clones/keeli/officer.mdl"},
    description = [[]],
    weapons = {"sw_datapad", "weapon_cuff_elastic", "weapon_rpw_binoculars", "rw_sw_nade_thermal", "rw_sw_dc15le", "rw_sw_z6", "rw_sw_dc15s", "rw_sw_dc17", "rw_sw_pinglauncher", "weapon_shield_activator", "rw_sw_dual_dc17ext",},
...
TEAM_KC_HP_1STLT = DarkRP.createJob("Heavy Platoon | 1st LT", {
    ...
    model = {"models/aussiwozzi/phase1clones/keeli/officer.mdl"},
    description = [[]],
    weapons = {"sw_datapad", "weapon_rpw_binoculars", "weapon_cuff_elastic", "rw_sw_nade_thermal", "rw_sw_dc15le", "rw_sw_z6", "rw_sw_dc15s", "rw_sw_dc17", "rw_sw_pinglauncher", "weapon_shield_activator", "rw_sw_dual_dc17ext",},
